...
- **Deliver / Conductor** is an advanced assembly pattern: visible role workers, task/report files, and human/trusted-orchestrator reconciliation.
...
- Conductor creates and harvests its own worktrees and does not delegate either operation to Swarm. The pinned runtime has no product-enforced approval gate or durable autonomous recovery.
